...
{
	iki_sensitize(dp, "xsim.dir/tb_keygen_top_behav/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1124104, dp + 1045384, 0, 63, 0, 63, 64, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1256936, dp + 1045384, 64, 127, 0, 63, 64, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1389768, dp + 1045384, 128, 191, 0, 63, 64, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1123896, dp + 1045496, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1256728, dp + 1045496, 1, 1, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1389560, dp + 1045496, 2, 2, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1124008, dp + 1045552, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1256840, dp + 1045552, 1, 1, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1389672, dp + 1045552, 2, 2, 0, 0, 1, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/tb_keygen_top_behav/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/tb_keygen_top_behav/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/tb_keygen_top_behav/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/tb_keygen_top_behav/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, isimBridge_getWdbWriter(), 0, argc, argv);
